...
class DatabaseService {
  ...
  Future<void> _seedExerciseTypes(Database db) async {
    final types = [
      ...
      {'nombre': 'Trote 2.4km', 'clave': 'trote', 'categoria': 'cardio', 'metrica_principal': 'tiempo', 'icono': 'directions_run'},
      {'nombre': 'Natación 450m', 'clave': 'natacion', 'categoria': 'cardio', 'metrica_principal': 'tiempo', 'icono': 'pool'},
      {'nombre': 'Cabo', 'clave': 'cabo', 'categoria': 'fuerza_superior', 'metrica_principal': 'tiempo', 'icono': 'sports_gymnastics'},
      {'nombre': 'VO2 Rockport', 'clave': 'vo2_rockport', 'categoria': 'cardio', 'metrica_principal': 'tiempo', 'icono': 'favorite'},
    ];
    for (final t in types) {
      // Usar INSERT OR IGNORE pero por si acaso cambiaron la clave en un futuro
      await db.insert('exercise_types', t, conflictAlgorithm: ConflictAlgorithm.replace);
    }
  }
