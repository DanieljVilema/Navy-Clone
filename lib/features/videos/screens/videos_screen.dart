...
class VideosScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final items = context.watch<ContentProvider>().videos;
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.play_circle_outline, size: 36, color: AppColors.darkTextTertiary),
                  ),
                  const SizedBox(height: Spacing.m),
                  Text('Sin videos disponibles', style: GoogleFonts.inter(fontSize: 20, fontWeight: FontWeight.w600, color: AppColors.darkTextPrimary)),
                  const SizedBox(height: Spacing.s),
                  SizedBox(
                    width: 280,
                    child: Text('Los videos de entrenamiento se cargarán aquí.', textAlign: TextAlign.center, style: GoogleFonts.inter(fontSize: 14, color: AppColors.darkTextSecondary)),
                  ),
                ],
              ),
            )
                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        child: const Icon(Icons.play_circle_fill, size: 22, color: AppColors.warning),
                      ),
